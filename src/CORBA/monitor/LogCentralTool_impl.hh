...
public:
   ...
   */
  CORBA::Short
  connectTool(char*& toolName, const char* msgReceiver);
...
private:
   ...
   */
  bool
  getToolByName(const char* toolName, ToolList::ReadIterator* it);
   ...
   */
  bool
  getFilterByName(const char* filterName, FilterList::ReadIterator* it);
};
...
public:
  ...
  ToolMsgReceiverFwdr_impl(Forwarder_ptr fwdr, const char* objName);
